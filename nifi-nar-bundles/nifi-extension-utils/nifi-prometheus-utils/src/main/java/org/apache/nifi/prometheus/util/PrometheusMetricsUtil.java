...
public class PrometheusMetricsUtil {
    ...
    public static CollectorRegistry createJvmMetrics(JvmMetricsRegistry jvmMetricsRegistry, JvmMetrics jvmMetrics, String instId) {
        ...
        jvmMetricsRegistry.setDataPoint(jvmMetrics.totalUsed(DataUnit.B), "JVM_MEMORY_TOTAL_USED", instanceId);
        jvmMetricsRegistry.setDataPoint(jvmMetrics.totalCommitted(DataUnit.B), "JVM_MEMORY_TOTAL_COMMIITTED", instanceId);
